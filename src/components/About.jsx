...
const About = () => {
  return (
    <section className="pt-32 px-6 lg:px-20  text-center">
      <h2 className="text-3xl lg:text-5xl font-bold text-purple-500 mb-4">About Us</h2>
      <h3 className="text-xl lg:text-2xl font-bold text-black mb-2">
        VTS BUILD THE SKILLS TO DRIVE YOUR
      </h3>
      <h3 className="text-xl lg:text-2xl  font-bold text-purple-500">IT CAREER!!</h3>
      ...
      <div className="flex flex-col mb-6 lg:flex-row items-center gap-10">
        ...
        <div className="w-full lg:w-1/2  text-black text-xl lg:text-xl leading-relaxed">
          <p className="mb-4  text-start">
            ...
            Startup <span className="text-purple-400 font-bold">Vetri IT Systems</span>{" "}
