...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white shadow-md px-6 md:px-12 py-4 w-full fixed top-0 left-0 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
          <div className="flex items-center space-x-2 md:space-x-4">
            <img src={Logo} alt="Vetri Technology Solutions" className="h-20 animate-pulse mr-5 md:h-24" />
          ...
          <button
      className="bg-gradient-to-r from-[#EB40DA] to-[#4D1AB1] animate-bounce text-white px-6 py-2 rounded-tl-2xl rounded-br-2xl font-medium hover:opacity-80 w-full md:w-auto"
